...
class PlayerManager:
    ...
    def on_volume_changed(self, player, status, _=None):
        logger.debug(f"Volume changed for player {player.props.player_name}: {status}")
        self.on_metadata_changed(player, player.props.metadata)
    ...
    def on_metadata_changed(self, player, metadata, _=None):
        ...
        volume = int(player.props.volume * 100)
